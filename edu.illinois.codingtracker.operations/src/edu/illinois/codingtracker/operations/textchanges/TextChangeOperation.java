...
public abstract class TextChangeOperation extends UserOperation {
	...
	private void updateCurrentState() {
		...
		if (currentEditor instanceof CompareEditor) {
			//MHcurrentViewer= EditorHelper.getEditingSourceViewer((CompareEditor)currentEditor);
		} else if (currentEditor instanceof AbstractDecoratedTextEditor) {
			//MH currentViewer= EditorHelper.getEditingSourceViewer((AbstractDecoratedTextEditor)currentEditor);
		}
